...
import { deleteTestimoni, findById, updateTestimoni } from "../_action";
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const updatedTestimoni = await updateTestimoni(parseInt(id), updatedData)
...
export async function DELETE(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        await deleteTestimoni(parseInt(id))
