...
import { deleteFasilitas, findById, updateFasilitas } from "../_action";
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const updatedTestimoni = await updateFasilitas(parseInt(id), updatedData)
...
export async function DELETE(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        await deleteFasilitas(parseInt(id))
